...
void bc7_codec_encode_block(uint8_t out_block[16], const uint8_t in_rgba_4x4[64], Bc7Quality quality);
...
size_t bc7_codec_encode_image(uint8_t* out_blocks, size_t out_cap, const uint8_t* rgba, int w, int h,
							  Bc7Quality quality);
