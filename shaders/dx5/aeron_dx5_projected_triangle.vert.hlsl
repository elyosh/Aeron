/* DX5 Direct3D v1 transformed/projected vertex compatibility path. */
...
/* Mirrors D3DGpuVertex in src/dx5/d3d.c, minus the D3DTLVERTEX specular colour:
 ...
 * attribute locations in src/dx5/d3d.c must match them. */
struct VertexInput {
